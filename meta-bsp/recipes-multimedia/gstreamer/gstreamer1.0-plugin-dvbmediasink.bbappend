...
SRC_URI_append_vuduo4kse = " file://dvbvideosink_vp9.patch"
...
EXTRA_OECONF_append_vuduo4k = " --with-vb9 --with-dtsdownmix --with-dts=yes"
EXTRA_OECONF_append_vuduo4kse = " --with-vb9 --with-dtsdownmix --with-dts=yes"
